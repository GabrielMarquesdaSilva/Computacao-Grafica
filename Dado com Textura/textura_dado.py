...
def DrawGLScene():
    ...
    # Top Face
    glTexCoord2f(2/3, 0/2); glVertex3f(-1.0,  1.0, -1.0)   
    glTexCoord2f(3/3, 0/2); glVertex3f(-1.0,  1.0,  1.0)    
    glTexCoord2f(3/3, 1/2); glVertex3f( 1.0,  1.0,  1.0)    
    glTexCoord2f(2/3, 1/2); glVertex3f( 1.0,  1.0, -1.0)   

    # Bottom Face       
    glTexCoord2f(0/3, 1/2); glVertex3f(-1.0, -1.0, -1.0)   
    glTexCoord2f(1/3, 1/2); glVertex3f( 1.0, -1.0, -1.0)   
    glTexCoord2f(1/3, 2/2); glVertex3f( 1.0, -1.0,  1.0)   
    glTexCoord2f(0/3, 2/2); glVertex3f(-1.0, -1.0,  1.0)    
    
    # Right face
    glTexCoord2f(1/3, 0/2); glVertex3f( 1.0, -1.0, -1.0)    
    glTexCoord2f(2/3, 0/2); glVertex3f( 1.0,  1.0, -1.0)   
    glTexCoord2f(2/3, 1/2); glVertex3f( 1.0,  1.0,  1.0)    
    glTexCoord2f(1/3, 1/2); glVertex3f( 1.0, -1.0,  1.0)  
